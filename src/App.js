...
function App() {
  ...
  return (
    ...
    <div>
      <div className="relative overflow-x-hidden bg-white text-black dark:bg-gray-900 dark:text-white">
          {/* Navbar */}
          <nav className="p-3 flex justify-between items-center dark:bg-gray-800 shadow-bd">
            {/* Logo */}
            ...
            <div className="lg:flex hidden flex-1 gap-2 justify-end">
              {/* <button onClick={setDarkTheme}>
                {
                  dark?(<MdDarkMode className="text-3xl"/>):(<MdOutlineDarkMode className="text-3xl"/>)
                }
              </button> */}
              ...
              <button className="flex gap-2 items-center border border-gray-300 px-6 py-2 rounded-lg hover:border-gray-500">
                <img src="assets/asset 1.svg" alt="icon" className="dark:text-white"></img>
            ...
            <div id="hero" className="min-h-screen bg-gradient-to-b from-purple-50 via-orange-50 to-transparent">
              <div id="hero-container" className="max-w-4xl mx-auto px-6 pb-32 pt-5 flex flex-col sm:items-center sm:text-center sm:pt-12">
                ...
                <div id="buttons-container" className="mt-12 flex gap-4 flex-col sm:flex-row">
                  ...
                  <button className="px-8 py-3 font-semibold rounded-lg bg-white dark:bg-black border border-gray-400 hover:border-gray-800 dark:text-white">Read Docs</button>
                </div>
              </div>
          ...
          <footer class="px-6 max-w-7xl mt-16 mx-auto lg:px-8 lg:mt-32 font-display">
            <div class="rounded-lg border border-gray-100 dark:border-none flex flex-col lg:flex-row-reverse items-center px-8 py-12 gap-8">
                <FaGithub className="text-xl text-gray-500 dark:text-white"/>
                <FaTwitter className="text-xl text-gray-500 dark:text-white"/>
                <a href="/#" class="font-display text-gray-400 text-lg dark:text-white">Documentation</a>
                <div class="flex gap-8 text-lg">
                    <a href="/#" class="text-gray-600 hover:text-gray-900 dark:text-white"><i class="fa-brands fa-twitter"></i></a>
                    <a href="/#" class="text-gray-600 hover:text-gray-900 dark:text-white"><i class="fa-brands fa-github"></i></a>
                </div>
                <a href="/#" id="brand" class="flex gap-2 items-center flex-1">
                    ...
                    <span class="text-lg font-medium font-display dark:text-white">ToDesktop</span>
                </a>
            </div>

            <div id="sub-footer" class="flex flex-col gap-6 items-center justify-center my-12">
                <div class="flex gap-2 items-center ">
                    <img class="w-4 h-4 dark:text-white" src="./assets/asset 48.svg" alt="Y-combinator"/>
                    <p class="text-sm text-gray-600 dark:text-white">A Y Combinator company.</p>
                </div>
                <p class="text-sm text-gray-400 dark:text-white">© 2025 ToDesktop, Inc. All rights reserved.</p>
            </div>
        </footer>
      </div>
    </div>
